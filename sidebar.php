...
<div id="menu-content" el-id="menu-content" class="el-init el-hide-complete" style="visibility: hidden; opacity: 0; transform: matrix(1, 0, 0, 1, 0, 0)">
    ...
    </div><div id="menu-content-main__restricted-wrapper" class="restricted-container-fluid h-100">
      <div id="menu-content-main__wrapper" class="container-fluid no-padding-x-axis">
        <div id="menu-content-main__row" class="row no-gutters align-items-center justify-content-center">
          <div class="col-10 col-xxl-9">
            <div class="row no-gutters justify-content-center"><div id="top-menu" class="col-12">
              <div id="home-btn" href="/" data-index="home" internal-route="" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
              <?php esc_html_e( 'Let\'s introduce ourselves', 'woocommerce' ); ?></div>
            </div><div id="primary-menu" class="col-12">
              <div class="row no-gutters justify-content-center">
                <div id="menu-content__level-1" class="col-12 col-lg-6">
                  <div id="menu-content__level-1-accordion" role="tablist" aria-multiselectable="true"><!-- BRAND BTN -->
                      ...
                      <div class="card-header" role="tab" id="headingTwo" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                        ...
                        <div class="card-block">
                          <div class="list-group">
                            <a id="brand-btn" href="/corporate/identity" class="list-group-item list-group-item-action" data-index="home" internal-route="">
                            Identity</a>
                            <a id="designers-btn" href="/corporate/designers" class="list-group-item list-group-item-action" data-index="home" internal-route="">
                            Designers</a>
                            <a id="history-btn" href="/corporate/production" class="list-group-item list-group-item-action" data-index="home" internal-route="">
                            Production</a>
                            <a id="partners-btn" href="/corporate/partners" class="list-group-item list-group-item-action" data-index="home" internal-route="">
                            Partners</a>
                          </div>
                        </div>
                      </div> -->
                    ...
                    <!-- <div class="card">
                      <div class="card-header" role="tab" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                        <a id="collection-btn" class="collapsed" data-toggle="collapse" data-parent="#menu-content__level-1-accordion" href="#collection-collapse" data-index="home">
                        Collezioni iconiche</a>
                      </div><div id="collection-collapse" class="collapse" role="tabpanel">
                        <div class="card-block">
                          <div class="list-group">
                            <a href="/project-code" class="list-group-item list-group-item-action" data-index="project-code" internal-route="">
                            Project_Code</a>
                            <a href="/collection/kitchens" class="list-group-item list-group-item-action" data-index="kitchens" internal-route="">
                            Kitchens</a>
                            <a href="/collection/bathrooms" class="list-group-item list-group-item-action" data-index="bathrooms" internal-route="">
                            Bathrooms</a>
                            <a href="/collection/outdoors" class="list-group-item list-group-item-action" data-index="home" internal-route="">
                            Outdoor</a>
                            <a href="/collection/systems" class="list-group-item list-group-item-action" data-index="systems" internal-route="">
                            Systems</a>
                            <a href="/collection/complementary-items" class="list-group-item list-group-item-action" data-index="items" internal-route="">
                            Complementary items</a>
                          </div>
                        </div>
                      </div>
                    </div> -->
...
<div class="card">
<div class="card-header" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
<a id="architects-btn" class="collapsed" href="/people" data-index="home" internal-route="">
...
<div id="menu-content__level-2" class="col-12 col-lg-6"></div>
</div>
</div>
</div><div class="row no-gutters">
<div id="secondary-menu" class="col-12"><div>
</div>
</div>
</div>
</div>
